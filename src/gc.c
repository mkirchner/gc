...
static void* gc_allocate (GarbageCollector *gc, size_t count, 
...
void* gc_malloc_static (GarbageCollector *gc, size_t size, 
    void(*dtor)(void*))
{
...
void* gc_malloc_ext (GarbageCollector *gc, size_t size, 
    void(*dtor)(void*))
{
